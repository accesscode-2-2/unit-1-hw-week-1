...
//  Pokemon
//
//  Created by Brian Blanco on 7/30/15.
...
@property NSDictionary *allPokemon;
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView {
    NSArray *types = [self.allPokemon allKeys];
    return types.count;
}

- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    NSArray *typesOfAllPokemons = [self.allPokemon allKeys];
    NSString *type = typesOfAllPokemons[section];
    NSArray *pokemonOfThisType = self.allPokemon[type];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSArray *arrayOfPokemon = [self.allPokemon objectForKey:type];
    NSString *pokemonName = [arrayOfPokemon objectAtIndex:indexPath.row];
